...
@property (nonatomic,strong) MVVMViewModel *mv;
...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = buttonItem;
     [self.tableView registerNib:[UINib nibWithNibName:@"MVVMTableViewCell" bundle:nil] forCellReuseIdentifier:@"custom"];
    self.view.backgroundColor =[UIColor whiteColor];
    [self.view addSubview:self.tableView];
    
    //TableView精简瘦身部分
    __weak typeof(self) weakSelf = self;
    self.dataSouce = [[MUDataSource alloc] initWithIdentifier:@"custom" configureBlock:^(MVVMTableViewCell *cell, MVCObject *model, NSIndexPath *indexPath) {
        //对应赋值
    ...
    self.mv = [[MVVMViewModel alloc]init];
